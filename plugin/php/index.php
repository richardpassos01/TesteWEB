...
<!--Chama pagina PHP atravez de Herança que contem layout com bootstrap e efeitos navbar+carrosel-->
...
<!--Div bootstrap com efeito estilizado, para informar ao usuário em que campo ele está----->	
 ...
 <!--Cria Formulario para cadastro das mercadorias-->	
	...
	<!--Insere os campos do Formulario-->				
				 <div class="form-group">
					<center>	
					<label for="inputTyoe" class="col-sm-4 control-label">Tipo da Mercadoria</label>
					<div class="col-sm-5">
					  <input type="text" class="form-control" required="" name="tipo_mercadoria" placeholder="EX: Camisa, Sapato, etc..." 
				 ...
				 <div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="text" class="form-control" required="" name="nome_mercadoria" placeholder="EX: Camisa Polo, Calça X marca, etc..." 
					  aria-describedby="basic-addon1">
					</div>			
				 </div>
				 ...
				 <div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="number" min="1" class="form-control" required="" name="quantidade" placeholder="Quantas unidades do produto?" 
					  aria-describedby="basic-addon1">
					</div>			
				 </div>
				 ...
				 <div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="number" class="form-control" min="1"  step=0.01 name="preco" placeholder="Qual o preço do produto?" 
					  aria-describedby="basic-addon1">
					</div>			
				 </div>
				...
				<div class="form-group">
					<div class="col-sm-offset-4 col-sm-5">
					  <button type="submit" class="btn btn-default">Avançar</button> <input type="reset" class="btn btn-default">
					</div>  
				</div>
				</center>			  
			</form>
